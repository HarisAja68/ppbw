...
<div class="card card-info card-outline">
    <div class="card-header">
        <form class="card-title" method="GET" action="{{ url('poco')}}">
        ...
        <table class="table table-bordered table-striped">
            ...
            <tbody>
                    ...
                    <tr>
                        ...
                        <td>{{$value->harga}}</td>
                        <td>{{$value->stok}}</td>
                        <td><a href="{{ url('poco/' .$value->id)}}" class="btn btn-sm btn-success"><i class="fas fa-eye"></i> Detail</a></td>
                        <td><a href="{{ url('poco/' .$value->id .'/edit')}}" class="btn btn-sm btn-warning"><i class="fas fa-edit"></i> Edit</a></td>
                        <td>
