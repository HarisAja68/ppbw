...
@section('title', 'Edit Data samsung')
...
<div class="col-md-12">
    <div class="card card-primary">
        ...
        <form method="POST" action="{{ url('samsung/'.$model->id)}}" enctype="multipart/form-data">
        @csrf
        @method('PUT')
            <div class="card-body">
                ...
                <div class="form-group">
                    ...
                    <div class="alert alert-danger">{{$msg}}</div>
                    @endforeach
                    <img src="{{ asset('images/foto_samsung/'.$model->foto)}}" width="100px"/>
                </div>
                <div class="form-group">
                    <label>Harga</label>
