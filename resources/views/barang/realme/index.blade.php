...
<div class="card card-info card-outline">
    <div class="card-header">
        <form class="card-title" method="GET" action="{{ url('realme')}}" enctype="multipart/form-data">
        ...
        <table class="table table-bordered table-striped">
            ...
            <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            @can('barang_update')
                            <a href="{{ url('realme/' .$value->id .'/edit')}}" style="margin-bottom: 10px" class="btn btn-sm btn-warning"><i class="fas fa-edit"></i> Edit</a>
                            @endcan
                            @can('barang_delete')
