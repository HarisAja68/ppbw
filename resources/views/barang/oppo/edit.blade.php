...
@section('title', 'Edit Data Oppo')
@section('oppo_active', 'active')
...
<div class="col-md-12">
    <div class="card card-primary">
        <div class="card-header">
            <h3 class="card-title">Form Oppo</h3>
        </div>
        <form method="POST" action="{{ url('oppo/'.$model->id)}}" enctype="multipart/form-data">
        @csrf
        @method('PUT')
            <div class="card-body">
                ...
                <div class="form-group">
                    ...
                    <div class="alert alert-danger">{{$msg}}</div>
                    @endforeach
                    <img src="{{ asset('images/foto_oppo/'.$model->foto)}}" width="100px"/>
                </div>
                <div class="form-group">
                    <label>Harga</label>
