        ...
        <div class="card-header">
            ...
            <div class="card-tools">
                <div class="d-inline-flex">
                    ...
                    @can('karyawan_create')
                        <a href="{{ route('karyawan.create') }}" class="btn btn-primary mx-3"><i class="fas fa-plus"></i>
                            Tambah</a>
                        <a href="{{ url('cetak_karyawan') }}" target="_blank" class="btn btn-success"><i
                                class="fas fa-print"></i> Cetak Table</a>
                    @endcan
                </div>
                ...
                <tbody>
                    @foreach ($datas as $key => $value)
                        <tr>
                            ...
                            <td>
                                @can('karyawan_update')
                                    <a href="{{ route('karyawan.edit', $value->id) }}" style="margin-bottom: 10px"
